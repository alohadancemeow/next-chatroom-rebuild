"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Ab:function(){return sA},Bt:function(){return sC},IO:function(){return si},JU:function(){return iD},PL:function(){return sw},QT:function(){return sg},ad:function(){return iM},ar:function(){return sa},cf:function(){return sE},hJ:function(){return ik},pl:function(){return sv},r7:function(){return s_},vr:function(){return sS}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i6{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new iN(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new i7(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(se("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class i7 extends i6{data(){return super.data()}}function se(e,t){return"string"==typeof t?i9(e,t):t instanceof iO?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sg(e){e=iI(e,iN);let t=iI(e.firestore,iL);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iu({next:s=>{t.enqueueAndForget(()=>rP(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rB(e9(n.path),s,{includeMetadataChanges:!0,ra:!0});return rF(e,a)})(await ig(e),e.asyncQueue,t,n,r)),r.promise})(iV(t),e._key).then(n=>sI(t,e,n))}class sy extends sc{constructor(e){super(),this.firestore=e}convertBytes(e){return new iP(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iN(this.firestore,null,t)}}function sw(e){e=iI(e,iA);let t=iI(e.firestore,iL),n=iV(t),r=new sy(t);return st(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rB(n,new iu({next:n=>{t.enqueueAndForget(()=>rP(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,ra:!0});return rF(e,s)})(await ig(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sp(t,r,e,n))}function sv(e,t,n){var r;e=iI(e,iN);let i=iI(e.firestore,iL),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sT(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Fu(s.merge||s.mergeFields?2:0,t,n,i);i2("Data must be an object, but it was:",l,r);let u=i0(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i3(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i5(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new i$(new eM(u),a,o)})(ij(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tx.none())])}function s_(e,t,n,...r){e=iI(e,iN);let i=iI(e.firestore,iL),s=ij(i);return sT(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iO?function(e,t,n,r,i,s){let a=e.Fu(1,t,n),o=[i3(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i3(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i5(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Su(t);if(n instanceof iW)u.push(t);else{let e=iZ(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iz(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Fu(1,t,n);i2("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i9(t,e,n);r=(0,h.m9)(r);let l=i.Su(o);if(r instanceof iW)s.push(o);else{let e=iZ(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iz(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sE(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iR(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iR(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iN)a=iI(e.firestore,iL),o=e9(e._key.path),s={next:n=>{t[u]&&t[u](sI(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iI(e,iA);a=iI(n.firestore,iL),o=n._query;let r=new sy(a);s={next:e=>{t[u]&&t[u](new sp(a,r,n,e))},error:t[u+1],complete:t[u+2]},st(e._query)}return function(e,t,n,r){let i=new iu(r),s=new rB(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rF(await ig(e),s)),()=>{i.$a(),e.asyncQueue.enqueueAndForget(async()=>rP(await ig(e),s))}}(iV(a),o,c,s)}function sT(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r0(await ip(e).then(e=>e.syncEngine),t,n)),n.promise}(iV(e),t)}function sI(e,t,n){let r=n.docs.get(t._key),i=new sy(e);return new sf(e,i,t._key,r,new sd(n.hasPendingWrites,n.fromCache),t.converter)}function sC(){return new iY("serverTimestamp")}function sS(...e){return new iX("arrayUnion",e)}function sA(...e){return new iJ("arrayRemove",e)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iL(new D(t.getProvider("auth-internal")),new M(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ew(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.6.3",void 0),(0,o.KN)(m,"4.6.3","esm2017")}()}}]);